...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 backdrop-blur-md p-4">
      ...
      <div className="bg-[#181818] border border-[#252525] w-full max-w-95 rounded-2xl modal-shadow p-8 relative animate-in fade-in zoom-in-95 duration-200 text-center">
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-1.5 rounded-full text-[#888888] hover:text-white hover:bg-[#252525] transition cursor-pointer"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4 text-left">
          ...
          {/* Submit Button in iconic Spotify Green */}
          <button
            type="submit"
            disabled={loading}
