...
const SYSTEM_SHOUTOUT_REGEX =
  /(?:เข้ามาแล้ว|ออกจากห้อง|ออกจากแชท|สร้างห้อง|อัปเดตข้อมูลห้อง|เพิ่มที่นั่ง|แก้ไขที่นั่ง|ลบที่นั่ง|ได้ \+1 ใบ|ครบแล้ว!|ยกเลิก|กดได้|ลด\/ยกเลิก|เชิญ|ถูกเตะ|ล็อคที่นั่ง|รอจ่ายเงิน|ชำระเงิน|ปักหมุดข้อความ|เลิกปักหมุดข้อความ|ได้บัตรแล้ว|คิวหลุด|ขอกำลังเสริม)/;
